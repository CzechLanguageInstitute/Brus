...
namespace Hardcodet.Wpf.Toolbox.Controls.Files
{
		...
		public partial class FileSelector : UserControl
		{
			...
			protected virtual void OnFileNameChanged() {
				...
				args.RoutedEvent = FileNameChangedEvent;
		...
		FileNameChangedEvent = EventManager.RegisterRoutedEvent("FileNameChanged", RoutingStrategy.Bubble,
				typeof(RoutedEventHandler), typeof(FileSelector));
