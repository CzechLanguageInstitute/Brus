...
namespace Daliboris.Statistiky.UI.WPF.Controls.TreeListView
{
    public class TreeListView : TreeView
    {
        ...
        public TreeListView()
        {
            AddHandler(TreeListViewItem.IsMultiSelectedChangedEvent,
                new TreeListViewItemSelectionEventHandler(ItemMultiSelectChanged));
        }

        public static readonly RoutedEvent TreeItemsChangedEvent = EventManager.RegisterRoutedEvent("TreeItemsChanged",
        ...
        public static readonly DependencyProperty AllowMultiSelectProperty =
            DependencyProperty.Register("AllowMultiSelect", typeof(bool), typeof(TreeListView),
        ...
        internal bool InMultiSelect
        {
            get { return MultiSelectCounter > 0; }
        }
