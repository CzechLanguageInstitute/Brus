...
{
 public class SkupinaJevu : ICollection<Jevy>
 {
	private readonly SortedDictionary<string, Jevy> mgsdcJevy = new SortedDictionary<string, Jevy>();
	...
	public IEnumerator<Jevy> GetEnumerator()
	{
	...
	public bool Contains(Jevy item)
	{
	...
	public void CopyTo(Jevy[] array, int arrayIndex)
	{
	...
	public static SkupinaJevu operator +(SkupinaJevu skjv1, SkupinaJevu skjv2)
	{
	 ...
	 if (skjv1 != null)
	 {
		foreach (Jevy jvs in skjv1)
		{
		 Jevy jv = new Jevy(jvs.Typ, jvs.Zdroj.CelaCesta, jvs.Jazyk, jvs.Identifikator);
		 jv.Popis = jvs.Popis;
